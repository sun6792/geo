<template>
  <el-aside :width="isCollapsed ? '64px' : '220px'" class="sidebar">
    <div class="logo">
      ...
      <span v-if="!isCollapsed" class="logo-text">AI引流运营系统</span>
      <span v-else class="logo-text-mini">AI引流</span>
    </div>
    <el-menu :default-active="activeMenu" :collapse="isCollapsed" :collapse-transition="false"
      ...
      <template v-if="isAdmin">
        <el-menu-item index="/demo-search"><el-icon><Present /></el-icon><span>AI引流演示</span></el-menu-item>
        ...
        <el-menu-item index="/detection"><el-icon><Search /></el-icon><span>模型探测</span></el-menu-item>
...
.sidebar { background: #001529; transition: width 0.3s; overflow: hidden; display: flex; flex-direction: column; height: 100vh; }
.logo { height: 64px; display: flex; align-items: center; justify-content: center; padding: 0 16px; gap: 8px; flex-shrink: 0; }
...
.el-menu { border-right: none; flex: 1; overflow-y: auto; overflow-x: hidden; }
</style>
